...
// This proxy can be created by calling TiFortumo.createExample({message: "hello world"})
@Kroll.proxy(creatableInModule = TiFortumoModule.class)
public class ExampleProxy extends TiViewProxy {
    // Standard Debugging variables
    protected static final String LCAT = "ExampleProxy";
